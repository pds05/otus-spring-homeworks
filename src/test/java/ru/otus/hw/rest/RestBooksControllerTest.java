...
public class RestBooksControllerTest {
    ...
    void setUp() throws Exception {
        ...
        books = List.of(new BookDto(1L, "Book 1", new AuthorDto(1L, "Author 1"),
                List.of(new GenreDto(1L, "Genre 1"), new GenreDto(2L, "Genre 2"))));
        comments = List.of(new UserCommentDto(1L, "Comment 1 book 1", 1L),
                new UserCommentDto(2L, "Comment 2 book 1", 1L));
    }
